...
strand.flexibility['A3'].setLibraryRotamers(osprey.WILD_TYPE,'ALA', 'GLY','VAL','ASN','ARG','PHE','SER','THR','ASP','CYS','GLN','GLU','TRP','HIS','LEU','LYS','MET','TYR')
strand.flexibility['A4'].setLibraryRotamers(osprey.WILD_TYPE,'ALA', 'GLY','VAL','ASN','ARG','PHE','SER','THR','ASP','CYS','GLN','GLU','TRP','HIS','LEU','LYS','MET','TYR')
