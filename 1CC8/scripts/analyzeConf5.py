...
strand.flexibility['A2'].setLibraryRotamers('ALA', 'GLY','VAL','ASN','ARG','PHE','SER','THR','ASP','CYS','GLN','GLU','TRP','HIS','LEU','LYS','MET','TYR')
strand.flexibility['A36'].setLibraryRotamers(osprey.WILD_TYPE,'ALA', 'GLY','VAL','ASN','ARG','PHE','SER','THR','ASP','CYS','GLN','GLU','TRP','HIS','LEU','LYS','MET','TYR')
strand.flexibility['A42'].setLibraryRotamers(osprey.WILD_TYPE,'ALA', 'GLY','VAL','ASN','ARG','PHE','SER','THR','ASP','CYS','GLN','GLU','TRP','HIS','LEU','LYS','MET','TYR')
