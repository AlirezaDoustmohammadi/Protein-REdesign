...
strand.flexibility['A2'].setLibraryRotamers('ALA', 'GLY','VAL','ASN','ARG','PHE','SER','THR')
strand.flexibility['A3'].setLibraryRotamers(osprey.WILD_TYPE,'VAL','ASP','CYS','GLN','GLU','TRP')
strand.flexibility['A4'].setLibraryRotamers(osprey.WILD_TYPE,'GLY','HIS','LEU','LYS','MET','TYR')
